...
st.write("Monitoring multiple patients in real-time with alerts for abnormal ")
...
temp_bar_value = clamp((temp - 95) * 25)   
ox_bar_value = clamp(ox) 
 
        # --- Update progress bars --- 
patient_placeholders[p]["hr_bar"].progress(hr_bar_value, 
